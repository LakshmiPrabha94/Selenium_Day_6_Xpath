...
# def test_existing_counts(guvi_instance):  # Define a test named test_existing_counts, taking guvi_instance as input
#     followers_count = guvi_instance.get_followers_count()  # Get followers count from InstagramPageInfo instance
#     following_count = guvi_instance.get_following_count()  # Get following count from InstagramPageInfo instance
#     assert followers_count.isdigit()  # Assert followers count is not a plain digit
#     assert following_count.isdigit() # Assert following count is not a plain digit
